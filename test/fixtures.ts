...
function genericSingleStateValidDFA(): DFA {
    return new DFABuilder("ab").withNotFinalStates("start").withEdges.from("start").toSelf().over("ab").getResult();
}
...
export default {
    ...
    mediumTM,
    genericValidDFA,
    genericSingleStateValidDFA,
    genericEpsilonNFALargerAlphabet,
    genericInvalidDFA,
    genericEpsilonNFA,
    genericNFA,
    genericPDA,
